        ...
        return (
          <>
            ...
            <div className={styles["costum-blog-quote"]}>
              ...
              {item.introduction?.introduction ?? item.introduction.introduction}
            ...
            <h3 className="font-light mb-2">{data.body ?? item.body.body}</h3>
            ...
            <div className={styles["costum-blog-quote"]}>
              <ul className="flex flex-col my-4">
                {[3,57,8,876,5,432,34,567,8,7].map((item:any) => {
                  return (
                    <>
                      <span className="font-light mb-1">{item}</span>
                    </>
                  );
                })}
              </ul>
            ...
            <div className="h-4" />
            <span className={styles["costum-blog-span"]}>
              {data.mainIdea ?? item.mainIdea.title}
            </span>
            {/* ==================================================================== */}
            ...
            <div className="h-4" />
            <span className={styles["costum-blog-span"]}>
              {data.extraInformation ?? item.extraInformation.extraInformation}
            </span>
            ...
            <div className="h-4" />
            <span className={styles["costum-blog-span"]}>
              {data.conclusion ?? item.conclusion.Conclusion}
            </span>
